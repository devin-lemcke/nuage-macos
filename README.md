...
[![Mastodon: @lerboe](https://img.shields.io/badge/Mastodon-@lerboe@mastodon.social-purple.svg?style=flat)](https://mastodon.social/@lerboe)
...
<img alt="Nuage Main View" src="https://github.com/lerboe/nuage-macos/assets/762049/99d5e344-9b1b-4890-ac8d-6f15fd114be0">
...
```bash
brew install lerboe/tap/nuage
```
or by downloading the latest version right [here](https://github.com/lerboe/nuage-macos/releases). Note that Nuage is still in heavy development and on top of that written in SwiftUI, a very young framework. If you encounter a bug or miss a feature, don't hesitate to open a pull request.

## Dependencies

Nuage uses [SoundCloud](https://github.com/lerboe/soundcloud) to access SoundCloud's private API.
